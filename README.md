...
````
This is the first group project that we have at MAIN School, which consists of replicating the **[printf (3)](http://man7.org/linux/man-pages/man3/printf.3.html)** function of language c, calling it this way **_printf.**
...
-- ``d``
--``i``
### [Man_3_printf.](https://photos.google.com/search/_tra_/photo/AF1QipPJi-b7rP0v97STC6ezks7HRgrGGne45hoAtU0R)
## Functions we use.
...
````
## [Flowchart.](https://photos.google.com/search/_tra_/photo/AF1QipPJi-b7rP0v97STC6ezks7HRgrGGne45hoAtU0R)
## How to use.
### Complilation
All of the ``.c`` files along with a main.c file are to be compiled with ``gcc 4.8.4`` on Ubuntu 18.04 LTS with the flags ``-Wall Werror`` ``-Westra`` and ``-pedantic.``
...
```
## Contributors
- [Uchegbu Udemezue](https://github.com/FrancisUchegbu)
- [Luke Ihuoma](https://github.com/philipsscore)
